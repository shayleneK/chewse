...
const { recipes, selectedDifficulty, popupMessage, redirectRecipeId } =
    defineProps({
        recipes: Array,
    ...
    <div class="flex flex-col p-5 items-center">
        ...
        <div class="flex gap-4 justify-center flex-wrap">
            ...
            <div
                ...
                :key="recipe.id"
                class="bg-white mb-8 rounded-lg shadow-md flex w-1/3"
            >
                ...
                <div class="flex flex-col p-4 gap-4 w-full">
                    <div class="flex">
                        ...
                        <button
                            class="ml-auto text-sm h-10 px-4 py-2 bg-pink-500 hover:bg-pink-700 transition-colors text-white rounded"
